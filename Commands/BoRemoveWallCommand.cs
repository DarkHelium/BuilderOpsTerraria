...
{
	/// <summary>
	/// Removes all walls in the current selection.
	/// Usage: /bo_removewall
	/// </summary>
	public class BoRemoveWallCommand : ModCommand
	{
		public override CommandType Type => CommandType.Chat;

		public override string Command => "bo_removewall";

		public override string Description => "Remove all walls in your selection.";
		...
		public override void Action(CommandCaller caller, string input, string[] args)
		{
			...
			{
				int count = Systems.WorldEditSystem.RemoveWallRegion(selection);
				caller.Reply($"[BuilderOps] Removing {count} walls", Color.Orange);
			}
			else
			{
